...
{
    public static Player ToDomain(this PlayerRegisterDto registerDto) => new Player(registerDto.Id, registerDto.Name, 0, string.Empty);

    public static PlayerReadDto ToDto(this Player player) => new PlayerReadDto(player.Name, player.Balance);
